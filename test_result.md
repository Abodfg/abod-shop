...
user_problem_statement: "اختبار النظام الإداري المُحدث مع الإداري الثاني - اختبار شامل للنظام الإداري المتعدد المستويات مع تقسيم الإشعارات: الإداري الرئيسي (7040570081) يتلقى جميع الإشعارات، إداري النظام (1573526135) يتلقى نبض النظام فقط، مع اختبار جميع وظائف الإدارة والإشعارات الدورية"
