...
if [ -z "$emergent_url" ]; then
    emergent_url="https://abod-digital.preview.emergentagent.com"
fi
...
EOF
    ...
    2)
        ...
        # تحديث URL في الملف
        sed -i "s|https://abod-digital.preview.emergentagent.com|$emergent_url|g" "$output_dir/index.html"
    ...
    3)
        ...
        # تحديث URL في الملف
        sed -i "s|https://abod-digital.preview.emergentagent.com|$emergent_url|g" "$output_dir/index.php"
        ;;
...
EOF
    ...
    5)
        ...
        # تحديث جميع الـ URLs
        find "$output_dir" -type f \( -name "*.html" -o -name "*.php" -o -name ".htaccess" \) -exec sed -i "s|https://abod-digital.preview.emergentagent.com|$emergent_url|g" {} \;
