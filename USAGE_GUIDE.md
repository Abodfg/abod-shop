# دليل استخدام نظام Abod Card

## نظرة عامة
نظام Abod Card هو منصة متكاملة لبيع وإدارة البطاقات الرقمية عبر تليجرام، يتكون من:
- **بوت المستخدمين**: لتصفح وشراء البطاقات الرقمية
- **بوت الإدارة**: لإدارة المنتجات والأكواد والمستخدمين
- **لوحة تحكم ويب**: لمراقبة النظام والإحصائيات

## الوصول للنظام

### لوحة التحكم الويب
- الرابط: https://cardmartbot.preview.emergentagent.com
...
- **📂 إضافة فئة**: ربط فئات بالمنتجات مع تحديد السعر
...
#### إدارة الأكواد
- **➕ إضافة أكواد**: إضافة أكواد لفئات محددة
- **👁 عرض الأكواد**: متابعة الأكواد المستخدمة/المتاحة
- **🗑 حذف كود**: إدارة الأكواد المنتهية الصلاحية
...
- Collections منفصلة للمستخدمين، المنتجات، الطلبات، الأكواد
- فهرسة محسنة للأداء
