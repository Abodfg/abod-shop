...
Webhook: https://digital-cards-bot.preview.emergentagent.com/api/webhook/user/abod_user_webhook_secret
```
...
Webhook: https://digital-cards-bot.preview.emergentagent.com/api/webhook/admin/abod_admin_webhook_secret
```
...
```python
# السطر ~6321
url="https://digital-cards-bot.preview.emergentagent.com/api/webhook/user/new_user_webhook_secret_2024"

# السطر ~6326
url="https://digital-cards-bot.preview.emergentagent.com/api/webhook/admin/new_admin_webhook_secret_2024"
```
...
```bash
curl -X POST "https://digital-cards-bot.preview.emergentagent.com/api/set-webhooks"
```
