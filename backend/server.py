...
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┃                                                                   ┃
┃  🛍️  **[1]** متجر المنتجات    ➤  أحدث الألعاب والبطاقات        ┃
┃  💎  **[2]** محفظتي الرقمية    ➤  إدارة الرصيد والشحن          ┃  
┃  📦  **[3]** طلباتي وتاريخي    ➤  متابعة جميع مشترياتك          ┃
┃  🔥  **[4]** العروض الحصرية    ➤  خصومات وعروض محدودة         ┃
┃  💬  **[5]** الدعم المباشر     ➤  مساعدة فورية 24/7           ┃
┃  ℹ️  **[6]** معلومات المتجر    ➤  تعرف على خدماتنا            ┃
┃  🔄  **[7]** تحديث الحساب      ➤  تحديث البيانات الشخصية       ┃
┃  🎁  **[8]** مفاجآت اليوم      ➤  عروض وهدايا يومية           ┃
┃  📋  **[/menu]** القائمة الكاملة ➤  جميع الأوامر المتاحة       ┃
┃                                                                   ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛"""
...
async def handle_enhanced_help_for_unknown_input(telegram_id: int, user_input: str):
    """مساعدة محسنة للنصوص غير المفهومة"""
    help_text = f"""🤔 **لم أتمكن من فهم: "{user_input}"** 

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

✨ **طرق التنقل المتاحة:**

🔢 **الأرقام السريعة:** اكتب رقم من 1-8
• `1` ➤ 🛍️ متجر المنتجات
• `2` ➤ 💎 محفظتي الرقمية
• `3` ➤ 📦 طلباتي وتاريخي
• `4` ➤ 🔥 العروض الحصرية
...
📝 **الكلمات المفتاحية:** اكتب إحدى هذه الكلمات
• `متجر` أو `shop` للتسوق
• `محفظة` أو `wallet` للرصيد
• `طلبات` أو `orders` للطلبات
• `دعم` أو `support` للمساعدة
• `عروض` أو `offers` للخصومات
...
💡 **نصيحة:** استخدم الأزرار أدناه للوصول السريع!"""
