...
async def handle_user_start(telegram_id: int, username: str, first_name: str):
    ...
    welcome_text = f"""🌟 *أهلاً وسهلاً {name}!* 🌟

━━━━━━━ 🎮 *Abod Card* 🎮 ━━━━━━━

🛍️ *متجرك الموثوق للمنتجات الرقمية*
...
┃ 🎯 *ما نقدمه لك:*                                           ┃
┃                                                                           ┃
┃ 🎮 بطاقات الألعاب والشحن                                ┃
┃ 🎵 اشتراكات البرامج والتطبيقات                        ┃
┃ 🛒 بطاقات هدايا للمتاجر الرقمية                        ┃
┃ ⚡ تسليم فوري أو خدمة مخصصة                          ┃
┃ 🔒 أمان وثقة مضمونة                                    ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
